...
#Creating a list of word to use as the starting point for the game
words = ["apple", "banana", "cherry", "date", "elderbarry", "fig", "grape"]
...
# Create a function to allow the user to perfrom operations on the list 
def manipulate_list(current):
    print("Choose an operation:")
    print("1. Append a word to the end of the list")
    print("2.  Extebd the lust with another list")
    print("3. Concatenate the list with another list")
    print("4. Traverse the list and view its elements")
    print("5. Modify an element in the list")
    print("6. Insert an elmenent at a speific index in the list")
    ...
    if choice == 1:
        ...
        other_list = input("Enter a comma-separeted list to extend with: ").split(",")
